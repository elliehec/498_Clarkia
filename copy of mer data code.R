...
=======
  ggplot(data=growth_dec15, aes(x=trt,y=total_lf, fill = trt))+
  geom_boxplot(alpha=0.3)+ #, colour = "khaki4", fill = "cornsilk")+
  geom_jitter()#colour="darkslategrey")
#geom_jitter(data=growth_dec15, aes(x=trt, y=sec_lf_dec15), colour="pink")+
#scale_colour_manual(values = c("darkslategrey" = "Primary Leaves", "pink" = "Secondary Leaves"))+
#labs(colour = "Leaf Type")
>>>>>>> 5ed979f (latest changes)
